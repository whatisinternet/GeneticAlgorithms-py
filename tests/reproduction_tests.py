...
def test_it_should_return_an_array_of_size_8():
    ...
    asserted_pool = reproduction.reproduce(black_box,
                                           seeding_pool, 2)
...
def test_it_should_return_an_array_of_strings():
    seeding_pool = seeding.pool(2, 8)
    asserted_pool = reproduction.reproduce(black_box, seeding_pool, 2)
...
def test__build_dictionary_should_return_a_collection_of_size_8():
    ...
    asserted_dictionary = reproduction._build_dictionary(black_box,
                                                         seeding_pool, 2)
    assert len(asserted_dictionary) is 2
...
def test__sort_dictionary_should_sort_the_collection_by_weight_decending():
    seeding_pool = seeding.pool(2, 8)
    dictionary = reproduction._build_dictionary(black_box, seeding_pool, 2)
